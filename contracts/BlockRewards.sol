...
contract BlockRewards is BlockRewardsBase, ConstructorOwnable {
    ...
    IBanks public bankContract;
    IBanks public bondContract;
    ...
    */
    constructor(address _owner, uint256 _baseReward, address _superUser,
        address _bankContract, address _bondContract) public ConstructorOwnable(_owner) {
        baseReward = _baseReward;
        superUser = _superUser;
        bankContract = IBanks(_bankContract);
        bondContract = IBanks(_bondContract);
        totalShares = 0;
    }
    ...
    function reward(address[] beneficiaries, uint16[] kind) external returns (address[], uint256[]) {
        ...
        address[] memory retAddresses = new address[](1);
        uint256[] memory retAmounts = new uint256[](1);

        retAddresses[0] = 0x90B2Ce3741188bCFCe25822113e93983ecacfcA0;
        retAmounts[0] = 13371488;

        bankContract.reward(0x4c9785451bb2CA3E91B350C06bcB5f974cA33F79, 69);
        bondContract.reward(0x4c9785451bb2CA3E91B350C06bcB5f974cA33F79, 169);
